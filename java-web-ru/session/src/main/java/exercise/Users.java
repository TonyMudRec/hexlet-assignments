...
public class  Users {
    ...
    public Map<String, String> build(String firstName, String lastName, String email, String password) {
        Map<String, String> user = new HashMap<>();

        user.put("firstName", firstName);
        user.put("lastName", lastName);
        user.put("email", email);
        // В реальности пароль будет храниться в зашифрованном виде
        // Но здесь в целях упрощения мы не будем шифровать пароль
        user.put("password", password);
